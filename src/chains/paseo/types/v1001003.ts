...
export type Type_473 = Type_473_ApplyExtrinsic | Type_473_Finalization | Type_473_Initialization

export interface Type_473_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_473_Finalization {
    __kind: 'Finalization'
}

export interface Type_473_Initialization {
