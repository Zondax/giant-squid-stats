...
export interface Event_IdentityMigrator {
    __kind: 'IdentityMigrator'
    value: IdentityMigratorEvent
}
 ...
 * The `Event` enum of this pallet
 */
export type IdentityMigratorEvent = IdentityMigratorEvent_IdentityReaped | IdentityMigratorEvent_DepositUpdated

/**
 * The identity and all sub accounts were reaped for `who`.
 */
export interface IdentityMigratorEvent_IdentityReaped {
    __kind: 'IdentityReaped'
    who: Uint8Array
}
 ...
 */
export interface IdentityMigratorEvent_DepositUpdated {
    __kind: 'DepositUpdated'
    who: Uint8Array
    identity: bigint
    subs: bigint
}
