...
export type RuntimeParametersKey = RuntimeParametersKey_Inflation

export interface RuntimeParametersKey_Inflation {
    __kind: 'Inflation'
    value: ParametersKey
}

export type RuntimeParametersValue = RuntimeParametersValue_Inflation

export interface RuntimeParametersValue_Inflation {
    __kind: 'Inflation'
...
export type ParametersKey = ParametersKey_MinInflation | ParametersKey_MaxInflation | ParametersKey_IdealStake | ParametersKey_Falloff | ParametersKey_UseAuctionSlots

export interface ParametersKey_MinInflation {
    __kind: 'MinInflation'
}

export interface ParametersKey_MaxInflation {
    __kind: 'MaxInflation'
}

export interface ParametersKey_IdealStake {
    __kind: 'IdealStake'
}

export interface ParametersKey_Falloff {
    __kind: 'Falloff'
}

export interface ParametersKey_UseAuctionSlots {
    __kind: 'UseAuctionSlots'
}

export type ParametersValue = ParametersValue_MinInflation | ParametersValue_MaxInflation | ParametersValue_IdealStake | ParametersValue_Falloff | ParametersValue_UseAuctionSlots

export interface ParametersValue_MinInflation {
    __kind: 'MinInflation'
    value: bigint
}

export interface ParametersValue_MaxInflation {
    __kind: 'MaxInflation'
    value: bigint
}

export interface ParametersValue_IdealStake {
    __kind: 'IdealStake'
    value: bigint
}

export interface ParametersValue_Falloff {
    __kind: 'Falloff'
    value: bigint
}

export interface ParametersValue_UseAuctionSlots {
    __kind: 'UseAuctionSlots'
    value: boolean
}

export type Type_501 = Type_501_ApplyExtrinsic | Type_501_Finalization | Type_501_Initialization

export interface Type_501_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_501_Finalization {
    __kind: 'Finalization'
}

export interface Type_501_Initialization {
    __kind: 'Initialization'
}

export type Event = Event_System | Event_Scheduler | Event_Preimage | Event_Indices | Event_Balances | Event_TransactionPayment | Event_Staking | Event_Offences | Event_Session | Event_Grandpa | Event_Treasury | Event_ConvictionVoting | Event_Referenda | Event_Whitelist | Event_Parameters | Event_Claims | Event_Vesting | Event_Utility | Event_Proxy | Event_Multisig | Event_Bounties | Event_ChildBounties | Event_ElectionProviderMultiPhase | Event_VoterList | Event_NominationPools | Event_FastUnstake | Event_ParaInclusion | Event_Paras | Event_Hrmp | Event_ParasDisputes | Event_OnDemand | Event_Registrar | Event_Slots | Event_Auctions | Event_Crowdloan | Event_Coretime | Event_StateTrieMigration | Event_XcmPallet | Event_MessageQueue | Event_AssetRate | Event_Sudo
...
export interface Event_Parameters {
    __kind: 'Parameters'
    value: ParametersEvent
}
...
export interface Event_OnDemand {
    __kind: 'OnDemand'
    value: OnDemandEvent
}
 ...
 * Events type.
 */
export type SchedulerEvent = SchedulerEvent_Scheduled | SchedulerEvent_Canceled | SchedulerEvent_Dispatched | SchedulerEvent_RetrySet | SchedulerEvent_RetryCancelled | SchedulerEvent_CallUnavailable | SchedulerEvent_PeriodicFailed | SchedulerEvent_RetryFailed | SchedulerEvent_PermanentlyOverweight
 ...
 * The `Event` enum of this pallet
 */
export type ParametersEvent = ParametersEvent_Updated
 ...
 */
export interface ParametersEvent_Updated {
    __kind: 'Updated'
    /**
     ...
     */
    oldValue: (RuntimeParametersValue | undefined)
    /**
     * The new value after this call.
     */
    newValue: (RuntimeParametersValue | undefined)
}
...
export interface ParaInclusionEvent_CandidateBacked {
    ...
    value: [V7CandidateReceipt, Uint8Array, number, number]
}
...
export interface ParaInclusionEvent_CandidateTimedOut {
    ...
    value: [V7CandidateReceipt, Uint8Array, number]
}
 ...
 * The `Event` enum of this pallet
 */
export type OnDemandEvent = OnDemandEvent_OnDemandOrderPlaced | OnDemandEvent_SpotPriceSet

/**
 * An order was placed at some spot price amount by orderer ordered_by
 */
export interface OnDemandEvent_OnDemandOrderPlaced {
    __kind: 'OnDemandOrderPlaced'
    paraId: number
    spotPrice: bigint
    orderedBy: Uint8Array
}

/**
 * The value of the spot price has likely changed
 */
export interface OnDemandEvent_SpotPriceSet {
    __kind: 'SpotPriceSet'
    spotPrice: bigint
}
 ...
 * The `Event` enum of this pallet
 */
export type CoretimeEvent = CoretimeEvent_RevenueInfoRequested | CoretimeEvent_CoreAssigned
...
export type ProxyType = ProxyType_Any | ProxyType_NonTransfer | ProxyType_Governance | ProxyType_Staking | ProxyType_CancelProxy | ProxyType_Auction | ProxyType_NominationPools
...
export interface V7CandidateReceipt {
...
export type ProcessMessageError = ProcessMessageError_BadFormat | ProcessMessageError_Corrupt | ProcessMessageError_Unsupported | ProcessMessageError_Overweight | ProcessMessageError_Yield | ProcessMessageError_StackLimitReached
