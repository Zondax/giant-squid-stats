...
export interface HostConfiguration {
    ...
    asyncBackingParams: V7AsyncBackingParams
    maxPovSize: number
    ...
    executorParams: V7ExecutorParam[]
    ...
    approvalVotingParams: V7ApprovalVotingParams
...
export interface Schedule {
    assignments: [CoreAssignment, number][]
...
export type V7ExecutorParam = V7ExecutorParam_MaxMemoryPages | V7ExecutorParam_StackLogicalMax | V7ExecutorParam_StackNativeMax | V7ExecutorParam_PrecheckingMaxMemory | V7ExecutorParam_PvfPrepTimeout | V7ExecutorParam_PvfExecTimeout | V7ExecutorParam_WasmExtBulkMemory
...
export type Type_484 = Type_484_ApplyExtrinsic | Type_484_Finalization | Type_484_Initialization

export interface Type_484_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_484_Finalization {
    __kind: 'Finalization'
}

export interface Type_484_Initialization {
    __kind: 'Initialization'
}

export type Event = Event_System | Event_Scheduler | Event_Preimage | Event_Indices | Event_Balances | Event_TransactionPayment | Event_Staking | Event_Offences | Event_Session | Event_Grandpa | Event_Treasury | Event_ConvictionVoting | Event_Referenda | Event_Whitelist | Event_Claims | Event_Vesting | Event_Utility | Event_Proxy | Event_Multisig | Event_Bounties | Event_ChildBounties | Event_ElectionProviderMultiPhase | Event_VoterList | Event_NominationPools | Event_FastUnstake | Event_ParaInclusion | Event_Paras | Event_Hrmp | Event_ParasDisputes | Event_OnDemand | Event_Registrar | Event_Slots | Event_Auctions | Event_Crowdloan | Event_Coretime | Event_StateTrieMigration | Event_XcmPallet | Event_MessageQueue | Event_AssetRate | Event_Sudo
...
export type V7PvfExecKind = V7PvfExecKind_Backing | V7PvfExecKind_Approval
...
export type UpgradeStrategy = UpgradeStrategy_SetGoAheadSignal | UpgradeStrategy_ApplyAtExpectedBlock
