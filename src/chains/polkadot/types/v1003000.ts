...
export type Type_480 = Type_480_ApplyExtrinsic | Type_480_Finalization | Type_480_Initialization

export interface Type_480_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_480_Finalization {
    __kind: 'Finalization'
}

export interface Type_480_Initialization {
